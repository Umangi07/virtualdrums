...
void loop(void) 
{
 ...
 // ===                   PRESSURE SENSOR                        ===
 // ================================================================ 
 int kick1=analogRead(A0);
 int kick2=analogRead(A2);
 bool leg1=false;
 bool leg2=false;
 if(kick1<300)
 {
...
//   Serial.print(fifoCount);
 ...
 // ================================================================
  ...
  if(leg1 && headingDegrees>0 && headingDegrees<180 && play)
  Serial.print("a");
  else if(leg1 && headingDegrees>180 && headingDegrees<360 && play)
  Serial.print("d");
  else if(headingDegrees>0 && headingDegrees<180 && play)
  Serial.print("b");
  //else if(leg1)
  //Serial.print("c");
   
  
  else if(headingDegrees>180 && headingDegrees<360 && play)
  Serial.print("e");
  else if(leg1)
  Serial.print("f");
  if(!play && !leg1 && !leg2)
